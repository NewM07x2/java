...
public class InputSurvey extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (userInfoOnSession != null) {
			...
			out.println("    <p>名前：" + userName                                                                                  );
			out.println("      <input type=\"hidden\" name=\"NAME\"  value=\""+ userName +"\"> "                                    );
			out.println("    </p>                                                                                                  ");
			out.println("    <p>年齢：                                                                                             ");
			out.println("      <input type=\"number\" name=\"AGE\" maxlength = \"3\" id=\"ID_AGE\">                                ");
			out.println("    </p>                                                                                                  ");
			out.println("    <p>性別：                                                                                             ");
			...
			out.println("      <textarea name=\"MESSAGE\" rows=\"4\" cols=\"50\" maxlength = \"250\" id=\"ID_MESSAGE\"></textarea> ");
			out.println("    </p>                                                                                                  ");
			out.println("    <input type=\"submit\" value=\"回答する(SaveSurveyを起動)\" id=\"ID_SUBMIT\">                         ");
			out.println("  </form>                                                                                                 ");
			out.println("  <script type=\"text/javascript\" src=\"js/input_survey.js\"></script>                                   ");
			out.println("  <br>                                                                                                    ");
			out.println("  <a href=\"ShowAllSurvey\">回答一覧画面へ</a>                                                            ");
			out.println("  <br>                                                                                                    ");
